  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <Image
          source={require('../../assets/nndaa.jpg')} 
          style={styles.profileImage}
        />
        <View style={styles.profileTextContainer}>
          <Text style={styles.profileName}>Ananda Riswana</Text>
          <Text style={styles.profileEmail}>Anandariswana20@gmail.com</Text>
        </View>
      </View>

      <View style={styles.menuContainer}>
        <MenuItem title="My Orders" detail="Already have 20 orders" />
        <MenuItem title="Shipping Addresses" detail="5 addresses" />
        <MenuItem title="Payment Methods" detail="Visa **44" />
